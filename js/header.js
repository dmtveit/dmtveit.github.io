...
window.onscroll = function() {
    ...
    if ((currentScrollY > 0) && (prevScrollY === 0)) {
        ...
        document.getElementsByTagName("footer")[0].style.transform = "translate(0, calc(-1 * " + topHeaderHeight + "))";
        ...
        document.getElementsByTagName("footer")[0].style.transform = "translate(0, 0)";
    }
