...
window.onscroll = function() {
    ...
    if ((currentScrollY > 0) && (prevScrollY === 0)) {
        ...
        //document.getElementsByTagName("header")[0].style.transform = "translate(0, -" + stickyHeaderHeight.toString() + ")";
        //document.getElementsByTagName("main")[0].style.transform = "translate(0, -" + stickyHeaderHeight.toString() + ")";
